...
# Source0-md5:	3ec36832614f3efe35f6b5a67010589a
...
%{__make} install \
	DESTDIR=$RPM_BUILD_ROOT -C build-%{bootstrap}
%else
...
[ -d build-nox ] && install build-nox%{_sysconfdir}/DOC-* $RPM_BUILD_ROOT%{_datadir}/emacs/%{version}%{_sysconfdir}
